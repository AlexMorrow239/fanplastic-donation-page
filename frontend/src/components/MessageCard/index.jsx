...
export default function MessageCard({ donationMethod, setProgressStep, setIsMessageUpdated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (userMessage.trim() === '' && hasMessage) {
      ...
      try {
        ...
        await PaymentsService.updatePayment(updatedPayment);
        ...
        alert('An error occurred while updating your message. Please try again.');
      }
    } else {
  ...
  return (
    <>
      <p className="card-text text-center">
        Your donation has been received! Thank you for supporting our plastic pirates! Would you
        like to leave a personalized message for the crew?
      </p>
      <form
        onSubmit={(e) => {
          handleSubmit(e);
