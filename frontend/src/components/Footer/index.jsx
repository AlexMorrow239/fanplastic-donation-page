        ...
        <div className="container text-white pt-5 pb-5">
          <div className="row">
            <div className="col-6 col-md-3 mb-3 addressblock">
              <h5 className="text-soapboxblue text-uppercase mb-3">ADDRESS CAPE TOWN</h5>
              <p>UP Workspace</p>
            ...
            <div className="col-6 col-md-3 mb-3 addressblock">
              <h5 className="text-soapboxblue text-uppercase mb-3">ADDRESS AMSTERDAM</h5>
            ...
            <div className="col-6 col-md-3 mb-3 addressblock">
              ...
              <p>
                ...
                <a href="mailto:info@captainfanplastic.com" className="text-white">
          ...
          <div className="row">
            <div className="col addressblock">
              <p>
                ...
                <br />
                <span>NPC Registration number:</span> 2022 / 851501 / 08 <span>PBO number:</span>{' '}
                930080113
              </p>
            </div>
          </div>
