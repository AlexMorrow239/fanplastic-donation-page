    ...
    <>
      ...
      <div className="container-fluid intro-row my-5 text-left">
        <div className="titleblock">
          ...
          <p>
            Help us steer our ship to new horizons in South Africa, so that we connect children to
            their environment, help them fight plastic pollution and enable them to manage waste.
            Every time we get to <b>$2,500</b>, we’ll hoist our pirate flag at a new school.
          </p>
      ...
      <BoxMessages isMessageUpdated={isMessageUpdated} setIsMessageUpdated={setIsMessageUpdated} />
      <Footer />
    </>
  );
}
